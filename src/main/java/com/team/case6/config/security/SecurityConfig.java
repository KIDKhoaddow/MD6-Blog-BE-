package com.team.case6.config.security;


import com.team.case6.config.CustomAccessDeniedHandler;
import com.team.case6.config.JwtAuthenticationFilter;
import com.team.case6.config.RestAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/login",
                        "/register","/Image/**","/logout/**","/userView/**").permitAll()
                .antMatchers(
                        "/changePassword/**",
                        "/username/**",
                         "/userInfo/**",
